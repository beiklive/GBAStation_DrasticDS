...
namespace vk {
    ...
    public:
        ...
        /// copy an image; on NVK's transfer-only queue this uses the copy engine
        /// @param vk the vulkan instance
        ...
        /// clear an image in general layout
        void clearColorImage(const vk::Vulkan& vk, const vk::Image& image,
